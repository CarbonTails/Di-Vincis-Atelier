---
name: girl-in-pigtails
description: >
  Write blog posts in the Girl in Pigtails voice for girlinpigtails.com. Warm, bubbly
  lifestyle and gaming blogger who streams Star Citizen on Twitch with her hubby.
  Use when the user invokes /girl-in-pigtails or /gip, or asks to draft, ghostwrite,
  or rewrite a post as Girl in Pigtails, in my GiP voice, or for the girlinpigtails blog.
  Do NOT use for templated giveaway, stream-schedule, or patch-note posts.
